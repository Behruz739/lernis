...
function ComingSoonPage({ onUnlock }: { onUnlock: () => void }) {
  ...
  return (
    <>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-100/40 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 relative overflow-hidden flex items-center justify-center">
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          {/* Description */}
          <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 mb-4 max-w-2xl mx-auto">
            Tez orada maxsus yangiliklar bilan qaytamiz!
          </p>

          {/* Date Info */}
          <div className="inline-flex items-center gap-2 px-6 py-3 bg-blue-50 dark:bg-blue-900/20 border-2 border-blue-200 rounded-full text-blue-700 font-semibold mb-8">
            <Clock className="h-5 w-5" />
            <span>Yanvar 2026 yilda ochiladi</span>
          </div>

          {/* Contact Info */}
          <div className="bg-white dark:bg-gray-800/80 backdrop-blur-md rounded-2xl shadow-xl p-8 border border-gray-200 dark:border-gray-700/50 mb-6">
            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-6">Biz bilan bog'lanish</h2>
      ...
      {showPasswordModal && (
        ...
        >
          <div
            className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-md w-full p-6 relative animate-in fade-in zoom-in"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Close Button */}
            <button
              onClick={closeModal}
              className="absolute top-4 right-4 text-gray-400 hover:text-gray-600 dark:text-gray-300 transition-colors"
            ...
            <div className="text-center mb-6">
              ...
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Parol kiriting</h2>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 pr-12 bg-white dark:bg-gray-700 text-gray-900 dark:text-white border-2 border-gray-200 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all placeholder-gray-500 dark:placeholder-gray-400"
                    autoFocus
                  />
                  <button
                    type="button"
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-100/40 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-10 items-center">
            ...
            <div className="relative z-20">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/60 dark:bg-gray-800/60 backdrop-blur-md border border-blue-100 dark:border-blue-900 shadow-sm mb-6 hover:scale-105 transition-transform duration-300 cursor-default">
                <span className="relative flex h-2 w-2">
                  <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-blue-400 opacity-75"></span>
                  <span className="relative inline-flex rounded-full h-2 w-2 bg-blue-50 dark:bg-blue-900/20"></span>
                </span>
                <span className="text-xs font-bold text-blue-600 dark:text-blue-400 tracking-wide">RAQAMLI TA'LIM PLATFORMASI</span>
              </div>

              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-black tracking-tight text-gray-900 dark:text-white mb-3 leading-tight">
                Ta'lim yutuqlaringiz <br className="hidden sm:block" />
                <span className="text-blue-600 dark:text-blue-400">Raqamli Dunyoda</span>
              </h1>

              <p className="mt-2 max-w-lg text-base sm:text-lg text-gray-600 dark:text-gray-300 leading-relaxed font-medium">
              ...
              <div className="mt-4 flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5">
                <Link to="/auth/register" className="group relative inline-flex items-center justify-center gap-2 rounded-full px-5 py-2.5 text-sm font-bold text-white bg-gray-900 dark:bg-blue-600 shadow-lg hover:bg-black dark:hover:bg-blue-700 hover:shadow-xl hover:scale-105 transition-all duration-300">
                ...
                <button type="button" className="group inline-flex items-center justify-center gap-2 rounded-full px-5 py-2.5 text-sm font-bold text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300">
                  <div className="w-6 h-6 rounded-full bg-blue-50 dark:bg-blue-900/50 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                    <Play className="h-3 w-3 text-blue-600 dark:text-blue-400 ml-0.5" fill="currentColor" />
                  </div>
              ...
              <div className="mt-5 relative w-full max-w-md">
                <form onSubmit={handleSearch} className="relative flex items-center bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-1.5 shadow-sm transition-all duration-300 hover:shadow-md hover:border-gray-300 dark:hover:border-gray-600 group">
                  <div className="pl-3 pr-2 text-gray-400 dark:text-gray-500">
                    <Search className="h-5 w-5 group-focus-within:text-gray-600 dark:group-focus-within:text-gray-300 transition-colors" />
                  </div>
                  <input
                    type="text"
                    ...
                    className="flex-1 h-10 bg-transparent outline-none text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 font-medium text-sm"
                  />
                  <button
                    type="submit"
                    className="ml-2 rounded-xl bg-gray-900 dark:bg-blue-600 px-5 py-2.5 text-xs font-bold text-white shadow-sm hover:bg-black dark:hover:bg-blue-700 transition-all duration-300 active:scale-95"
                  >
                    Tekshirish
                  </button>
                </form>
              ...
              <div className="mt-4 flex flex-wrap items-center gap-x-4 gap-y-2 text-xs text-gray-500 dark:text-gray-400 font-medium">
                ...
                <div className="flex items-center gap-1.5">
                  <QrCode className="h-3.5 w-3.5 text-purple-500 dark:text-purple-400" />
            ...
            <div className="hidden md:block relative h-[600px] w-full perspective-1000">
              ...
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[380px] bg-white dark:bg-gray-800/40 backdrop-blur-xl rounded-3xl border border-white dark:border-gray-700/60 shadow-2xl p-6 animate-float z-20">
              ...
              <div className="absolute top-20 right-10 w-48 bg-white dark:bg-gray-800/30 backdrop-blur-lg rounded-2xl border border-white dark:border-gray-700/50 shadow-xl p-4 animate-bounce-slow z-10" style={{ animationDelay: '1s' }}>
                <div className="flex flex-col items-center text-center">
                  ...
                  <div className="font-bold text-gray-800 dark:text-gray-100 text-sm">Top Student</div>
                  <div className="text-xs text-gray-600 dark:text-gray-300">Spring 2024</div>
                </div>
              </div>

              {/* Stats Card - Floating Bottom Left */}
              <div className="absolute bottom-32 left-0 w-56 bg-white dark:bg-gray-800/30 backdrop-blur-lg rounded-2xl border border-white dark:border-gray-700/50 shadow-xl p-4 animate-float-gentle z-30" style={{ animationDelay: '2s' }}>
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <div className="font-bold text-gray-900 dark:text-white">2,450 XP</div>
                  </div>
                </div>
                <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-1.5 mb-1">
                  <div className="bg-purple-600 h-1.5 rounded-full w-[75%]"></div>
                </div>
                <div className="text-right text-[10px] text-gray-500 dark:text-gray-400">Top 5%</div>
              </div>

              {/* Decorative Elements */}
              <div className="absolute top-1/4 left-10 w-12 h-12 bg-blue-50 dark:bg-blue-900/20/20 rounded-full blur-xl animate-pulse"></div>
              <div className="absolute bottom-1/4 right-20 w-20 h-20 bg-purple-50 dark:bg-purple-900/20/20 rounded-full blur-xl animate-pulse" style={{ animationDelay: '1.5s' }}></div>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={index} className={`group relative overflow-hidden rounded-3xl ${stat.bgClass} backdrop-blur-md border border-white dark:border-gray-700/60 p-6 text-center hover:-translate-y-1 transition-all duration-300 hover:shadow-xl`}>
      ...
      <section id="how-it-works" className="py-16 relative">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 rounded-full text-blue-700 text-sm font-semibold mb-6">
              <div className="w-2 h-2 bg-blue-50 dark:bg-blue-900/20 rounded-full animate-pulse"></div>
              Qanday ishlaydi
            </div>
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-extrabold text-gray-900 dark:text-white mb-4">Platforma qanday ishlaydi</h2>
            <p className="text-base md:text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">Hujjatlar, badge'lar, ilmiy ishlar va hamjamiyat — barchasi bir joyda</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              <div key={index} className={`relative group overflow-hidden rounded-3xl p-8 ${item.bg} backdrop-blur-md border border-white dark:border-gray-700/60 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1`}>
                {/* Background Glow */}
                ...
                <h3 className="relative z-10 text-xl font-bold text-gray-900 dark:text-white mb-3">{item.title}</h3>
                <p className="relative z-10 text-gray-600 dark:text-gray-300 leading-relaxed font-medium">{item.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="features" className="py-16 relative">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-12">
            ...
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 dark:text-white mb-4 tracking-tight">Platforma imkoniyatlari</h2>
            <p className="text-base md:text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto font-medium">Lernis — hujjatlar, badge'lar, ilmiy ishlar va hamjamiyatni birlashtiruvchi to'liq raqamli ta'lim ekotizimi.</p>
          </div>

          {/* Features Grid */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[minmax(200px,auto)]">
            {/* Research Hub - Large */}
            <div className="md:col-span-2 md:row-span-2 group relative overflow-hidden rounded-3xl bg-gradient-to-br from-purple-50/80 to-indigo-50/80 dark:from-gray-800 dark:to-gray-900 backdrop-blur-xl border border-purple-100/50 dark:border-purple-900/20 p-8 hover:shadow-xl transition-all duration-300 hover:border-purple-200 dark:hover:border-purple-700">
              <div className="absolute inset-0 bg-white dark:bg-gray-800/40 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              <div className="relative z-10">
                <div className="w-12 h-12 rounded-2xl bg-white dark:bg-gray-800 flex items-center justify-center text-purple-600 mb-6 shadow-sm group-hover:scale-110 transition-transform duration-300">
                  <Database className="h-6 w-6" />
                </div>
                <h3 className="text-2xl md:text-3xl font-black text-gray-900 dark:text-white mb-3 tracking-tight">Research Hub</h3>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed font-medium max-w-md text-base md:text-lg">
                ...
                <div className="absolute right-0 bottom-0 translate-x-1/4 translate-y-1/4 w-64 h-64 opacity-60 group-hover:opacity-100 group-hover:translate-x-0 group-hover:translate-y-0 transition-all duration-500">
                  <div className="absolute top-0 right-10 w-40 h-52 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-purple-100 transform rotate-[-6deg] z-10 p-4">
                    <div className="w-full h-2 bg-purple-50 dark:bg-purple-900/20 rounded mb-2"></div>
                    <div className="w-3/4 h-2 bg-purple-50 dark:bg-purple-900/20 rounded mb-4"></div>
                    <div className="space-y-2">
                      <div className="w-full h-1.5 bg-gray-50 dark:bg-gray-900 rounded"></div>
                      <div className="w-full h-1.5 bg-gray-50 dark:bg-gray-900 rounded"></div>
                      <div className="w-5/6 h-1.5 bg-gray-50 dark:bg-gray-900 rounded"></div>
                    </div>
                  </div>
            ...
            {/* Gamification - Tall */}
            <div className="md:col-span-1 md:row-span-2 group relative overflow-hidden rounded-3xl bg-gradient-to-br from-orange-50/80 to-amber-50/80 dark:from-gray-800 dark:to-gray-900 backdrop-blur-xl border border-orange-100/50 dark:border-orange-900/20 p-8 hover:shadow-xl transition-all duration-300 hover:border-orange-200 dark:hover:border-orange-700">
              <div className="absolute inset-0 bg-white dark:bg-gray-800/40 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              <div className="relative z-10 h-full flex flex-col">
                <div className="w-12 h-12 rounded-2xl bg-white dark:bg-gray-800 flex items-center justify-center text-orange-600 mb-6 shadow-sm group-hover:scale-110 transition-transform duration-300">
                  <Award className="h-6 w-6" />
                </div>
                <h3 className="text-xl md:text-2xl font-black text-gray-900 dark:text-white mb-3 tracking-tight">Gamification</h3>
                ...
                <div className="mt-auto flex flex-col gap-3">
                  <div className="flex items-center gap-3 p-3 bg-white dark:bg-gray-800/60 backdrop-blur rounded-xl border border-orange-100 shadow-sm transform translate-x-4 group-hover:translate-x-0 transition-transform duration-300">
                    ...
                    <div className="text-sm font-bold text-gray-800 dark:text-gray-100">Top Student</div>
                  </div>
                  <div className="flex items-center gap-3 p-3 bg-white dark:bg-gray-800/60 backdrop-blur rounded-xl border border-orange-100 shadow-sm transform translate-x-8 group-hover:translate-x-0 transition-transform duration-300 delay-75">
                    ...
                    <div className="text-sm font-bold text-gray-800 dark:text-gray-100">Research Pro</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="md:col-span-2 group relative overflow-hidden rounded-3xl bg-gradient-to-br from-green-50/80 to-emerald-50/80 dark:from-gray-800 dark:to-gray-900 backdrop-blur-xl border border-green-100/50 dark:border-green-900/20 p-8 hover:shadow-xl transition-all duration-300 hover:border-green-200 dark:hover:border-green-700">
              <div className="absolute inset-0 bg-white dark:bg-gray-800/40 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center gap-6">
                <div className="flex-1">
                  <div className="w-12 h-12 rounded-2xl bg-white dark:bg-gray-800 flex items-center justify-center text-green-600 mb-6 shadow-sm group-hover:scale-110 transition-transform duration-300">
                    <Users className="h-6 w-6" />
                  </div>
                  <h3 className="text-xl md:text-2xl font-black text-gray-900 dark:text-white mb-2 tracking-tight">Global Hamjamiyat</h3>
                  <p className="text-gray-600 dark:text-gray-300 font-medium text-base md:text-lg">
                ...
                <div className="relative w-full md:w-1/3 h-24">
                  <div className="absolute top-0 right-0 bg-white dark:bg-gray-800 p-3 rounded-t-2xl rounded-bl-2xl shadow-sm border border-green-100 text-xs text-gray-600 dark:text-gray-300 transform group-hover:-translate-y-1 transition-transform duration-300">
            ...
            <div className="md:col-span-1 grid grid-cols-1 gap-6">
              {/* Digital Docs */}
              <div className="group p-6 rounded-3xl bg-gradient-to-br from-blue-50/80 to-cyan-50/80 dark:from-gray-800 dark:to-gray-900 backdrop-blur-xl border border-blue-100/50 dark:border-blue-900/20 hover:shadow-lg transition-all duration-300 hover:border-blue-200 dark:hover:border-blue-700">
                <FileText className="h-8 w-8 text-blue-600 mb-3 group-hover:scale-110 transition-transform duration-300" />
                <h3 className="font-bold text-gray-900 dark:text-white mb-1 text-lg">Raqamli hujjatlar</h3>
                <p className="text-sm text-gray-600 dark:text-gray-300 font-medium">Diplom va sertifikatlarni xavfsiz saqlash.</p>
              </div>
            </div>

            {/* Rating System */}
            <div className="md:col-span-1 group p-6 rounded-3xl bg-gradient-to-br from-indigo-50/80 to-blue-50/80 dark:from-gray-800 dark:to-gray-900 backdrop-blur-xl border border-indigo-100/50 dark:border-indigo-900/20 hover:shadow-lg transition-all duration-300 hover:border-indigo-200 dark:hover:border-indigo-700">
              <Target className="h-8 w-8 text-indigo-600 mb-3 group-hover:scale-110 transition-transform duration-300" />
              <h3 className="font-bold text-gray-900 dark:text-white mb-1 text-lg">Reyting tizimi</h3>
              <p className="text-sm text-gray-600 dark:text-gray-300 font-medium">GPA va faollik asosida reyting.</p>
            </div>

            {/* Security */}
            <div className="md:col-span-1 group p-6 rounded-3xl bg-gradient-to-br from-red-50/80 to-pink-50/80 dark:from-gray-800 dark:to-gray-900 backdrop-blur-xl border border-red-100/50 dark:border-red-900/20 hover:shadow-lg transition-all duration-300 hover:border-red-200 dark:hover:border-red-700">
              <Shield className="h-8 w-8 text-red-600 mb-3 group-hover:scale-110 transition-transform duration-300" />
              <h3 className="font-bold text-gray-900 dark:text-white mb-1 text-lg">Xavfsizlik</h3>
              <p className="text-sm text-gray-600 dark:text-gray-300 font-medium">Zero-Knowledge shifrlash.</p>
            </div>

            {/* QR Check */}
            <div className="md:col-span-1 group p-6 rounded-3xl bg-gradient-to-br from-teal-50/80 to-emerald-50/80 dark:from-gray-800 dark:to-gray-900 backdrop-blur-xl border border-teal-100/50 dark:border-teal-900/20 hover:shadow-lg transition-all duration-300 hover:border-teal-200 dark:hover:border-teal-700">
              <QrCode className="h-8 w-8 text-teal-600 mb-3 group-hover:scale-110 transition-transform duration-300" />
              <h3 className="font-bold text-gray-900 dark:text-white mb-1 text-lg">QR tekshiruv</h3>
              <p className="text-sm text-gray-600 dark:text-gray-300 font-medium">Tezkor verification.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="user-roles" className="py-12 relative">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 rounded-full text-blue-700 text-xs font-semibold mb-4">
              <Users className="h-3 w-3" />
              Foydalanuvchi rollari
            </div>
            <h2 className="text-2xl md:text-3xl font-black text-gray-900 dark:text-white mb-3 tracking-tight">Har bir rol uchun maxsus imkoniyatlar</h2>
          </div>
            ...
            {[
              ...
              <button
                ...
                className={`flex items-center gap-2 px-5 py-2.5 rounded-full font-bold text-sm transition-all duration-300 ${activeRole === role.id
                  ...
                  : 'bg-white dark:bg-gray-800 text-gray-600 hover:bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700'
                  }`}
              >
                {role.icon}
                {role.label}
          ...
          <div className="relative min-h-[400px]">
            {[
              ...
              >
                <div className={`rounded-3xl bg-white dark:bg-gray-800/80 backdrop-blur-xl border border-white dark:border-gray-700/60 shadow-xl overflow-hidden`}>
                  <div className="grid md:grid-cols-2 gap-0">
                    ...
                    <div className={`hidden md:flex bg-gradient-to-br ${role.bgGradient} p-8 items-center justify-center relative overflow-hidden`}>
                      {/* Abstract Shapes */}
                      <div className="absolute top-0 right-0 w-40 h-40 bg-white dark:bg-gray-800/20 rounded-full blur-2xl transform translate-x-1/2 -translate-y-1/2"></div>
                      <div className="absolute bottom-0 left-0 w-40 h-40 bg-white dark:bg-gray-800/20 rounded-full blur-2xl transform -translate-x-1/2 translate-y-1/2"></div>
      ...
      <section id="testimonials" className="py-12 relative overflow-hidden">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-green-50 dark:bg-green-900/20 border border-green-200 rounded-full text-green-700 text-xs font-semibold mb-3">
              <CheckCircle className="h-3 w-3" />
              Ishonch
            </div>
            <h2 className="text-2xl md:text-3xl font-black text-gray-900 dark:text-white mb-3 tracking-tight">Foydalanuvchilar fikri</h2>

            {/* Trust Counter */}
            <div className="inline-flex items-center gap-3 px-5 py-2.5 bg-white dark:bg-gray-800/80 backdrop-blur-xl border border-gray-100 rounded-2xl shadow-sm">
              <div className="flex -space-x-2">
                <div className="w-7 h-7 rounded-full bg-gradient-to-br from-blue-500 to-cyan-500 border-2 border-white dark:border-gray-700 flex items-center justify-center text-white text-xs font-bold shadow-sm">T</div>
                <div className="w-7 h-7 rounded-full bg-gradient-to-br from-purple-500 to-pink-500 border-2 border-white dark:border-gray-700 flex items-center justify-center text-white text-xs font-bold shadow-sm">N</div>
                <div className="w-7 h-7 rounded-full bg-gradient-to-br from-orange-500 to-red-500 border-2 border-white dark:border-gray-700 flex items-center justify-center text-white text-xs font-bold shadow-sm">S</div>
              </div>
              <div className="text-left">
                <div className="text-xl font-black text-gray-900 dark:text-white">500+</div>
                <div className="text-xs text-gray-600 dark:text-gray-300 font-medium">Muassasa ishonadi</div>
              </div>
            </div>
          </div>
              ...
              {[
                {
                  ...
                  logoBg: "bg-blue-50 dark:bg-blue-900/20/80",
                  logoText: "TATU"
                },
                {
                  ...
                  logoBg: "bg-green-50 dark:bg-green-900/20/80",
                  logoText: "O'zMU"
                },
                {
                  ...
                  logoBg: "bg-purple-50 dark:bg-purple-900/20/80",
                  logoText: "Uzum"
                },
                {
                  ...
                  logoBg: "bg-orange-50 dark:bg-orange-900/20/80",
                  logoText: "TDIU"
                },
                {
                ...
                <div key={index} className="flex-shrink-0 w-full md:w-[calc(50%-12px)] snap-start">
                  <div className="group relative overflow-hidden rounded-3xl bg-white dark:bg-gray-800/70 backdrop-blur-xl border border-white dark:border-gray-700/40 shadow-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-1 p-6 h-full">
                    ...
                    <div className="relative z-10 flex flex-col h-full">
                      ...
                      <div className="flex items-center justify-between mb-4">
                        <div className={`w-14 h-14 rounded-2xl ${testimonial.logoBg} backdrop-blur-xl flex items-center justify-center shadow-sm border border-white dark:border-gray-700/40 group-hover:scale-110 transition-transform duration-300`}>
                      ...
                      {/* Content */}
                      <p className="text-gray-600 dark:text-gray-300 italic mb-6 leading-relaxed text-sm flex-grow">"{testimonial.content}"</p>

                      {/* Author Info */}
                      <div className="pt-4 border-t border-gray-100">
                        <h4 className="font-bold text-gray-900 dark:text-white text-sm">{testimonial.name}</h4>
                        <p className="text-xs text-gray-500 dark:text-gray-400 font-medium">{testimonial.role}, {testimonial.institution}</p>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <section id="about" className="py-12 relative">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="text-center mb-10">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-orange-50 dark:bg-orange-900/20 border border-orange-200 rounded-full text-orange-700 text-xs font-semibold mb-3">
              <Award className="h-3 w-3" />
              Biz haqimizda
            </div>
            <h2 className="text-2xl md:text-3xl font-black text-gray-900 dark:text-white mb-4 tracking-tight">Lernis haqida</h2>
            <p className="text-base text-gray-600 dark:text-gray-300 leading-relaxed max-w-3xl mx-auto font-medium">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
            {/* Mission */}
            <div className="group relative overflow-hidden rounded-3xl bg-white dark:bg-gray-800/70 backdrop-blur-xl border border-white dark:border-gray-700/40 p-8 shadow-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-1">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-xl font-black text-gray-900 dark:text-white mb-3 tracking-tight">Missiyamiz</h3>
            ...
            <div className="group relative overflow-hidden rounded-3xl bg-white dark:bg-gray-800/70 backdrop-blur-xl border border-white dark:border-gray-700/40 p-8 shadow-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-1">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-xl font-black text-gray-900 dark:text-white mb-3 tracking-tight">Vizyonimiz</h3>
                <p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <div key={index} className="group relative overflow-hidden rounded-2xl bg-white dark:bg-gray-800/70 backdrop-blur-xl border border-white dark:border-gray-700/40 p-5 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <h4 className="text-sm font-bold text-gray-900 dark:text-white mb-1">{value.title}</h4>
      ...
      <section id="pricing" className="py-12 relative">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="text-center mb-10">
            ...
            <h2 className="text-2xl md:text-3xl font-black text-gray-900 dark:text-white mb-4 tracking-tight">Har bir rol uchun mos narxlar</h2>
            <p className="text-base text-gray-600 dark:text-gray-300 max-w-3xl mx-auto font-medium">Barcha funksiyalar bilan boshlang. Istalgan vaqtda bekor qiling.</p>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                  ...
                  <div key={idx} className={`relative rounded-2xl p-4 md:p-6 transition-all duration-300 hover:-translate-y-1 ${plan.highlighted
                    ...
                    : 'bg-white dark:bg-gray-800/70 backdrop-blur-xl border border-white dark:border-gray-700/40 shadow-sm hover:shadow-xl'
                    }`}>
                    {plan.highlighted && (
                    ...
                    <div className={`text-center mb-4 md:mb-6 ${plan.highlighted ? 'text-white' : 'text-gray-900 dark:text-white'}`}>
                      ...
                      <p className={`text-sm ${plan.highlighted ? 'text-blue-100' : 'text-gray-500 dark:text-gray-400'}`}>{plan.period}</p>
                      <p className={`text-xs mt-2 ${plan.highlighted ? 'text-blue-100' : 'text-gray-600 dark:text-gray-300'}`}>{plan.description}</p>
                    </div>
                    ...
                    <button className={`w-full py-3 rounded-full font-bold text-sm transition-all ${plan.highlighted
                      ? 'bg-white dark:bg-gray-800 text-blue-600 hover:bg-blue-50 dark:bg-blue-900/20'
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                  ...
                  <div key={idx} className={`relative rounded-2xl p-4 md:p-6 transition-all duration-300 hover:-translate-y-1 ${plan.highlighted
                    ...
                    <div className={`text-center mb-6 ${plan.highlighted ? 'text-white' : 'text-gray-900 dark:text-white'}`}>
                      ...
                      <p className={`text-sm ${plan.highlighted ? 'text-purple-100' : 'text-gray-500 dark:text-gray-400'}`}>{plan.period}</p>
                      <p className={`text-xs mt-2 ${plan.highlighted ? 'text-purple-100' : 'text-gray-600 dark:text-gray-300'}`}>{plan.description}</p>
                    </div>
                    <ul className="space-y-3 mb-6">
                      {plan.features.map((feature, i) => (
                        <li key={i} className="flex items-center gap-2">
                    ...
                    <button className={`w-full py-3 rounded-full font-bold text-sm transition-all ${plan.highlighted
                      ? 'bg-white dark:bg-gray-800 text-purple-600 hover:bg-purple-50 dark:bg-purple-900/20'
                      : 'bg-gray-900 text-white hover:bg-black'
                      }`}>
                      {plan.cta}
                    </button>
                ...
                {[
                  ...
                  <div key={idx} className={`relative rounded-2xl p-4 md:p-6 transition-all duration-300 hover:-translate-y-1 ${plan.highlighted
                    ...
                    <div className={`text-center mb-6 ${plan.highlighted ? 'text-white' : 'text-gray-900 dark:text-white'}`}>
                      ...
                      <p className={`text-sm ${plan.highlighted ? 'text-green-100' : 'text-gray-500 dark:text-gray-400'}`}>{plan.period}</p>
                      <p className={`text-xs mt-2 ${plan.highlighted ? 'text-green-100' : 'text-gray-600 dark:text-gray-300'}`}>{plan.description}</p>
                    </div>
                    <ul className="space-y-3 mb-6">
                      {plan.features.map((feature, i) => (
                        <li key={i} className="flex items-center gap-2">
                    ...
                    <button className={`w-full py-3 rounded-full font-bold text-sm transition-all ${plan.highlighted
                      ? 'bg-white dark:bg-gray-800 text-green-600 hover:bg-green-50 dark:bg-green-900/20'
                      : 'bg-gray-900 text-white hover:bg-black'
                      }`}>
                      {plan.cta}
                    </button>
                ...
                {[
                  ...
                  <div key={idx} className={`relative rounded-2xl p-4 md:p-6 transition-all duration-300 hover:-translate-y-1 ${plan.highlighted
                    ...
                    <div className={`text-center mb-6 ${plan.highlighted ? 'text-white' : 'text-gray-900 dark:text-white'}`}>
                      ...
                      <p className={`text-sm ${plan.highlighted ? 'text-orange-100' : 'text-gray-500 dark:text-gray-400'}`}>{plan.period}</p>
                      <p className={`text-xs mt-2 ${plan.highlighted ? 'text-orange-100' : 'text-gray-600 dark:text-gray-300'}`}>{plan.description}</p>
                    </div>
                    <ul className="space-y-3 mb-6">
                      {plan.features.map((feature, i) => (
                        <li key={i} className="flex items-center gap-2">
                    ...
                    <button className={`w-full py-3 rounded-full font-bold text-sm transition-all ${plan.highlighted
                      ? 'bg-white dark:bg-gray-800 text-orange-600 hover:bg-orange-50 dark:bg-orange-900/20'
                      : 'bg-gray-900 text-white hover:bg-black'
                      }`}>
                      {plan.cta}
                    </button>
      ...
      <section id="faq" className="py-20 md:py-16 relative">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          {/* Header */}
          <div className="text-center mb-10">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-purple-50 dark:bg-purple-900/20 border border-purple-200 rounded-full text-purple-700 text-xs font-semibold mb-3">
              <FileText className="h-3 w-3" />
              Yordam markazi
            </div>
            <h2 className="text-2xl md:text-3xl font-black text-gray-900 dark:text-white mb-4 tracking-tight">Ko'p so'raladigan savollar</h2>
            <p className="text-base text-gray-600 dark:text-gray-300 max-w-2xl mx-auto font-medium">Lernis haqida bilishingiz kerak bo'lgan hamma narsa</p>
          </div>
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={index} className="bg-white dark:bg-gray-800/70 backdrop-blur-xl rounded-2xl shadow-sm border border-white dark:border-gray-700/40 overflow-hidden hover:shadow-lg transition-all duration-300">
                <button
                ...
                >
                  ...
                  <div className={`flex-shrink-0 w-8 h-8 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center transition-transform duration-300 ${openFAQ === index ? 'rotate-180' : ''}`}>
                    <svg
      ...
      <section className="py-20 relative">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="relative rounded-[2.5rem] overflow-hidden bg-gray-900 dark:bg-gray-800 shadow-2xl border border-gray-800 dark:border-gray-700">
            {/* Background Effects */}
            <div className="absolute inset-0">
              <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-10 mix-blend-soft-light"></div>
              <div className="absolute -top-24 -right-24 w-96 h-96 bg-blue-600/30 rounded-full blur-[100px]"></div>
              <div className="absolute -bottom-24 -left-24 w-96 h-96 bg-purple-600/30 rounded-full blur-[100px]"></div>
            </div>
            ...
            <div className="relative z-10 px-6 py-16 md:px-12 md:py-20 text-center">
              ...
              <p className="text-lg md:text-xl text-gray-300 mb-10 font-medium max-w-2xl mx-auto leading-relaxed">
                Lernis'dan foydalanayotgan minglab muassasalarga qo'shiling. <br className="hidden md:block" />
                Bugun bepul sinovni boshlang.
              </p>

              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link
                  to="/auth/register"
                  className="group inline-flex items-center gap-2 rounded-full px-8 py-4 text-base font-bold bg-white text-gray-900 hover:bg-blue-50 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105"
                >
                ...
                <Link
                  to="/demo"
                  className="group inline-flex items-center gap-2 rounded-full px-8 py-4 text-base font-bold border border-gray-700 bg-gray-800/50 text-white hover:bg-gray-800 hover:border-gray-600 transition-all duration-300 backdrop-blur-sm"
                >
      ...
      <section id="contact" className="py-12 relative">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Waitlist Card */}
          <div className="relative overflow-hidden rounded-3xl bg-white dark:bg-gray-800/70 backdrop-blur-xl border border-white dark:border-gray-700/40 shadow-xl p-8 md:p-12">
            {/* Gradient Glow */}
            ...
            <div className="relative z-10 text-center">
              {/* Badge */}
              <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-purple-50 dark:bg-purple-900/20 border border-purple-200 rounded-full text-purple-700 text-xs font-semibold mb-4">
                <div className="h-1.5 w-1.5 bg-purple-50 dark:bg-purple-900/20 rounded-full animate-pulse"></div>
                Erta kirish ro'yxati
              </div>

              {/* Heading */}
              <h2 className="text-2xl md:text-3xl font-black text-gray-900 dark:text-white mb-3 tracking-tight">Waitlist'ga qo'shiling</h2>
              <p className="text-base text-gray-600 dark:text-gray-300 max-w-2xl mx-auto mb-8 font-medium">
              ...
              <form onSubmit={handleJoinWaitlist} className="max-w-md mx-auto">
                <div className="flex flex-col sm:flex-row gap-3">
                  <input
                    ...
                    className="flex-1 px-5 py-3.5 rounded-full border border-gray-200 bg-white dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent text-sm font-medium placeholder:text-gray-400"
      ...
      <section className="py-12 relative">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Header */}
          <div className="text-center mb-10">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 rounded-full text-blue-700 text-xs font-semibold mb-3">
              <Mail className="h-3 w-3" />
              Biz bilan bog'laning
            </div>
            <h2 className="text-2xl md:text-3xl font-black text-gray-900 dark:text-white mb-4 tracking-tight">Aloqa ma'lumotlari</h2>
            <p className="text-base text-gray-600 dark:text-gray-300 max-w-2xl mx-auto font-medium">Savolingiz bormi? Biz bilan bog'laning</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            {[
              ...
              <div key={index} className="group relative overflow-hidden rounded-2xl bg-white dark:bg-gray-800/70 backdrop-blur-xl border border-white dark:border-gray-700/40 p-6 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 text-center">
          ...
          {/* CTA Card */}
          <div className="relative overflow-hidden rounded-3xl bg-gray-900 dark:bg-gray-800 p-8 md:p-10 text-white shadow-2xl border border-gray-800 dark:border-gray-700">
            ...
            <div className="relative z-10 text-center">
              <h3 className="text-xl md:text-2xl font-black mb-3 text-white">Boshlashda yordam kerakmi?</h3>
              <p className="text-gray-300 mb-6 max-w-2xl mx-auto font-medium">
                Jamoamiz Lernis'ni muassasangizda joriy etishda yordam beradi
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                <Link
                  to="/contact"
                  className="inline-flex items-center gap-2 rounded-full px-6 py-3 text-sm font-bold bg-white text-gray-900 hover:bg-blue-50 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105"
                >
                ...
                <Link
                  to="/schedule-demo"
                  className="inline-flex items-center gap-2 rounded-full px-6 py-3 text-sm font-bold border border-gray-600 bg-gray-800/50 text-white hover:bg-gray-800 hover:border-gray-500 transition-all duration-300"
                >
