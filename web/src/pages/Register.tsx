...
import { Mail, Lock, Eye, EyeOff, Home, AlertCircle, ArrowRight, Sparkles, User } from 'lucide-react';
                ...
                <div className="bg-white/70 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/40 overflow-hidden flex flex-col md:flex-row">
                    ...
                    <div className="w-full md:w-1/2 p-6 lg:p-8">
                        ...
                        <div className="mb-6">
                            <Link
                                to="/"
                                className="inline-flex items-center gap-2 px-3 py-1.5 bg-blue-50 border border-blue-200 rounded-full text-blue-700 text-xs font-semibold mb-3 hover:bg-blue-100 transition-colors group"
                            >
                                <Home className="h-3 w-3" />
                                Bosh sahifaga qaytish
                            </Link>
                            <h1 className="text-2xl font-black text-gray-900 mb-1 tracking-tight">Ro'yxatdan o'tish</h1>
                            <p className="text-gray-600 font-medium">Hisobingizni yarating va o'qishni boshlang</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                ...
                                <div>
                                    <label className="block text-sm font-bold text-gray-900 mb-2">Familiya</label>
                                    <div className="relative">
                                        <User className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-400" />
                                        <input
                                            type="text"
                            ...
                            {/* Confirm Password */}
                            <div>
                                <label className="block text-sm font-bold text-gray-900 mb-2">Parolni tasdiqlang</label>
                                <div className="relative">
                                    <Lock className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-400" />
                                    <input
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <label className="text-sm text-gray-700 font-medium">
                                    Men{' '}
                                    <Link to="/terms" className="text-blue-600 hover:text-blue-700 font-bold">
                                        Foydalanish shartlari
                                    </Link>
                                    {' '}va{' '}
                                    <Link to="/privacy" className="text-blue-600 hover:text-blue-700 font-bold">
                                        Maxfiylik siyosati
                                    </Link>
                                    ni qabul qilaman
                                </label>
                        ...
                        <p className="mt-6 text-center text-sm text-gray-600 font-medium">
                            Hisobingiz bormi?{' '}
                            <Link to="/auth/login" className="font-bold text-blue-600 hover:text-blue-700 transition-colors">
                                Kirish
                            </Link>
                        </p>
                    </div>
                    ...
                    <div className="hidden md:block md:w-1/2 bg-gradient-to-br from-blue-600 via-purple-600 to-blue-800 relative overflow-hidden p-12">
                        ...
                        <div className="relative z-10 h-full flex flex-col justify-center">
                            <div className="mb-8">
                                ...
                                <h2 className="text-4xl font-black text-white mb-4 tracking-tight">Bugun boshlang</h2>
                                <p className="text-lg text-blue-100 font-medium leading-relaxed">
                                    Lernis bilan ta'lim sayohatingizni boshlang. Bepul ro'yxatdan o'ting va barcha imkoniyatlardan foydalaning.
                                </p>
                            </div>
                            ...
                            <div className="space-y-4">
                                {[
                                    { icon: '✨', text: 'Bepul boshlanish', desc: 'Hech qanday to\'lov talab qilinmaydi' },
                                    { icon: '🎓', text: 'Raqamli sertifikatlar', desc: 'Global tan olinadigan' },
                                    { icon: '📚', text: 'Tadqiqot materiallari', desc: 'Minglab resurslar' },
                                    { icon: '🔒', text: 'Xavfsiz saqlash', desc: 'Ma\'lumotlaringiz himoyalangan' }
                                ].map((benefit, index) => (
                                    <div key={index} className="flex items-start gap-3 text-white">
                                        <div className="w-10 h-10 rounded-lg bg-white/20 backdrop-blur-sm border border-white/30 flex items-center justify-center text-xl flex-shrink-0">
                                            {benefit.icon}
                                        </div>
                                        <div>
                                            <div className="font-bold">{benefit.text}</div>
                                            <div className="text-sm text-blue-200">{benefit.desc}</div>
                                        </div>
                                    </div>
                                ))}
                            </div>
